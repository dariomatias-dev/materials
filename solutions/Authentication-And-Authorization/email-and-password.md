...
Ao criar uma é importante verificar se o endereço de e-mail fornecido é válido, ou seja, existe.
...
Envio do código para o servidor:
...
Número de tentativas de Login em um e-mail será de 10. Ao atingir o limite será necessário esperar 1 dia para ser liberado.

Criar uma tabela vinculada a tabela de usuário que guardará o número total de tentativas e o tempo da última tentativa.
